...
output_magazine = OutputMagazine.new(params['output_magazine_starting_capacity'], params['output_magazine_maximal_capacity'], params['boards_from_beam'], params['output_magazine_beams'], params['output_magazine_boards'])
